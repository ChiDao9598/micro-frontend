  ...
  template: `
    <svg [attr.width]="size" [attr.height]="size" viewBox="0 0 24 24" fill="none"
      ...
      @switch (name) {
        ...
        @case ('server') {
          <path d="M21.75 17.25v.75a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25v-.75m16.5 0a2.25 2.25 0 00.75-1.661V8.25A2.25 2.25 0 0018 6H6a2.25 2.25 0 00-2.25 2.25v7.339a2.25 2.25 0 00.75 1.661m16.5 0H3.75m13.5-3.75a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm-9 0a.75.75 0 11-1.5 0 .75.75 0 011.5 0z"/>
        }
        @case ('rocket') {
